...
<head>
    ...
    <ul id="navbar">
        ...
        <li><a><div class="containerForLocal">
            <div class="switch">
                <form action="controller" method="post" id="forLanguageForm">
                <input type="hidden" name="flag" value="ready">
                <input type="radio" class="switch-input" onclick="this.form.submit();" name="command" value="switchLocale" id="en" checked>

                <label for="en" class="switch-label switch-label-off">EN</label>
                <input type="radio" class="switch-input" onclick="this.form.submit();" name="command" value="switchLocale" id="ru"
