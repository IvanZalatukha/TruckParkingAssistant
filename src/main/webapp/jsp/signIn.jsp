...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <h2 class="inactive underlineHover">
            <a class="underlineHover" href="<c:url value="/controller?command=goToRegistrationPage"/>">REGISTARION </a>
        </h2>
        ...
        <div id="formFooter">
            <a class="underlineHover" href="<c:url value="/controller?command=forgotPasswordPage"/>">Forgot Password?</a>
        </div>
